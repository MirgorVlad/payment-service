...
public final class WorkspaceConstants {
    ...
    public static final String CUSTOMERS_URL_PATTERN = "/api/customers";
    public static final String DEVICES_URL_PATTERN = "/api/devices";
    public static final String ASSETS_URL_PATTERN = "/api/assets";
