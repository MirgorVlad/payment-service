...
public class LatestUsagePricing implements PricingStrategy {
    ...
    public Long calculate(Long workspaceId, WorkspaceEntityType type, TimeInterval timeInterval) {
        return daoSnapshotService.findLatestEntityCountByWorkspaceAndPeriod(workspaceId, type, timeInterval)
                .orElse(0L);
    }

    @Override
    public PricingStrategyType getPricingStrategyType() {
        return PricingStrategyType.LATEST;
    }
}
