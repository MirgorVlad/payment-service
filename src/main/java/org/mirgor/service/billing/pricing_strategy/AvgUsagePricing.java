...
public class AvgUsagePricing implements PricingStrategy {
    ...
    public Long calculate(Long workspaceId, WorkspaceEntityType type, TimeInterval timeInterval) {
        return daoSnapshotService.findAvgEntityCountByWorkspaceAndPeriod(workspaceId, type, timeInterval)
                .orElse(0L);
    }

    @Override
    public PricingStrategyType getPricingStrategyType() {
        return PricingStrategyType.AVG;
    }
}
